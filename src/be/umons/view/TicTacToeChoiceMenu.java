...
public class TicTacToeChoiceMenu extends JFrame implements ActionListener {
	    ...
	    ActionListener radiobtnActionListener = new ActionListener() {
	    	public void actionPerformed(ActionEvent e) {	
	    		...
	    		if (btnHuman.isSelected()) {
	    			lab3.setIcon(new ImageIcon("Ressource/Games/TicTacToe/choicetheme.png"));
	    			lab3.repaint();
	    		...
	    		if (btnAI.isSelected() || btnAI2.isSelected()) {
	    			...
	    			if (btnAI.isSelected()) {	    				
	    				lab3.setIcon(new ImageIcon("Ressource/Games/TicTacToe/choicetheme2.png"));
	    				lab3.repaint();
	    				...
	    				lab3.setIcon(new ImageIcon("Ressource/Games/TicTacToe/choicetheme3.png"));
	    				lab3.repaint();
		    		...
		    		if (btnAI.isSelected() && btnAI2.isSelected()) {
		    			lab3.setIcon(new ImageIcon("Ressource/Games/TicTacToe/choicetheme4.png"));
		    			lab3.repaint();		
